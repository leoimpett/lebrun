(function() {
      ...
      // data paths
  var randomSelectionsPath = './data/captioned_random_selections/',
      nnPath = './data/captioned_nearest_neighbors/',
      imagePath = 'images/',
      ...
      // parameters
      galleryImages = 14, // total number of images to display in gallery
      slideshowImages = 10, // total number of images to display in slideshow
      randomSelections = 1, // total number of random image selections
    ...
    if (hoveredImageFilename) {
      ...
      _.take(nearestNeighbors, slideshowImages).forEach(function(nn, idx) {
        var container = containers[idx],
            ...
            similarity = Math.round(nn.similarity*100)/100,
            similarityElem = ' <div class="gray-text">Distance: ' + similarity + '</div>'
